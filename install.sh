...
green "下载并安装x-ui相关组件……"
cd /usr/local/
curl -L -o /usr/local/x-ui-linux-${cpu}.tar.gz -# --retry 2 --insecure https://github.com/leostarx9999/x-ui-yg/releases/download/xui_yg/x-ui-linux-${cpu}.tar.gz
...
cd
rm /usr/bin/x-ui -f
curl -L -o /usr/bin/x-ui -# --retry 2 --insecure https://raw.githubusercontent.com/leostarx9999/x-ui-yg/main/install.sh
...
echo "----------------------------------------------------------------------"
restart
curl -sL https://raw.githubusercontent.com/leostarx9999/x-ui-yg/main/version | awk -F "更新内容" '{print $1}' | head -n 1 > /usr/local/x-ui/v
showxuiip
sleep 2
xuigo
cronxui
...
green "x-ui已卸载完成"
echo
blue "欢迎继续使用x-ui脚本：bash <(curl -Ls https://raw.githubusercontent.com/leostarx9999/x-ui-yg/main/install.sh)"
echo
else
red "输入有误" && uninstall
fi
...
acme() {
bash <(curl -Ls https://raw.githubusercontent.com/leostarx9999/acme-yg/main/acme.sh)
back
}
...
cfwarp() {
bash <(curl -Ls https://raw.githubusercontent.com/leostarx9999/warp-yg/main/CFwarp.sh)
back
}
...
curl -L -o /usr/local/x-ui/xuiwpph -# --retry 2 --insecure https://raw.githubusercontent.com/leostarx9999/x-ui-yg/main/xuiwpph_$cpu
